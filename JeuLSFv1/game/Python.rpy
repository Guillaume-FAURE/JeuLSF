...
#Initialisation Variables du dictionnaire
    A = Mot("A","lettre_A_LSF")
    B = Mot("B","lettre_B_LSF")
    C = Mot("C","lettre_C_LSF")
    D = Mot("D","lettre_D_LSF")
    E = Mot("E","lettre_E_LSF")
    F = Mot("F","lettre_F_LSF")
    G = Mot("G","lettre_G_LSF")
    H = Mot("H","lettre_H_LSF")
    I = Mot("I","lettre_I_LSF")
    J = Mot("J","lettre_J_LSF")
    K = Mot("K","lettre_K_LSF")
    L = Mot("L","lettre_L_LSF")
    M = Mot("M","lettre_M_LSF")
    N = Mot("N","lettre_N_LSF")
    O = Mot("O","lettre_O_LSF")
    P = Mot("P","lettre_P_LSF")
    Q = Mot("Q","lettre_Q_LSF")
    R = Mot("R","lettre_R_LSF")
    S = Mot("S","lettre_S_LSF")
    T = Mot("T","lettre_T_LSF")
    U = Mot("U","lettre_U_LSF")
    V = Mot("V","lettre_V_LSF")
    W = Mot("W","lettre_W_LSF")
    X = Mot("X","lettre_X_LSF")
    Y = Mot("Y","lettre_Y_LSF")
    Z = Mot("Z","lettre_Z_LSF")
